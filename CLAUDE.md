...
- **Not in the Manager yet:** EC2-tier orchestrator visibility/control (Manager talks only to the hosted orchestrator; needs an `MATRX_EC2_ORCHESTRATOR_URL`/`_API_KEY`).
